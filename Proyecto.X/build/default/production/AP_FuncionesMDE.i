...
# 1 "./AP_FuncionesMDE.h" 1
# 34 "./AP_FuncionesMDE.h"
int s_llave_on ( void );
...
void t_simular ( void );
void t_simular ( void );
# 8 "AP_FuncionesMDE.c" 2

# 1 "./AP_Inicializacion.h" 1
# 13 "./AP_Inicializacion.h"
...
# 16 "AP_FuncionesMDE.c" 2
# 40 "AP_FuncionesMDE.c"
int antiReboteCounter = 0;
int botonEstadoPrevio = 0;
static unsigned char led_position = 0b00000001;


unsigned long t_antirebote_ini;
# 63 "AP_FuncionesMDE.c"
int s_llave_on ( void )
{
    return (PORTCbits.RC0);
}
# 79 "AP_FuncionesMDE.c"
int s_llave_off ( void )
{
    return !(PORTCbits.RC0);
}
# 93 "AP_FuncionesMDE.c"
int s_llave_up ( void )
{
...
# 168 "AP_FuncionesMDE.c"
void f_apagar ( void )
{
    LATDbits.LATD0 = 0;
    return ;
}
# 185 "AP_FuncionesMDE.c"
void f_encender ( void )
{
    LATDbits.LATD0 = 1;
    return ;
...
# 211 "AP_FuncionesMDE.c"
int e_antirebote ( void )
{
    int res = 0 ;

    if(cuenta_interrup-t_antirebote_ini >= 3.5)
  res=1;
...
int e_simular ( void )
{
    ...
    float var= rand() % 6 + 4;
    if(cuenta_interrup-t_antirebote_ini >= var)
  res=1;

    return res ;
}
# 291 "AP_FuncionesMDE.c"
int e_noSimular ( void )
{
    int res = 0 ;
